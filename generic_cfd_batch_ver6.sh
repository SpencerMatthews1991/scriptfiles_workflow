#!/bin/bash
##
## Generic CFD Batch Submission Script for PBS - modified for AoA sweep directory files
## --------------------------------------------
## Works with: Fluent, OpenFOAM, CFX, Star-CCM+, SU2, etc.
##
## STEP 1: Enter a job name
##
#PBS -N (Your_Job_Name)_cfd_batch_YYYYMMDD
##
## STEP 2: Select resources
##
#PBS -l select=1:ncpus=29:mpiprocs=29
##
...
##
#PBS -m abe
#PBS -M Your.EmailAddress@cranfield.ac.uk
##
## ====================================
...
pkill -u $USER fluent 2>/dev/null
sleep 10
...
FLUENT_NUM_STEPS="120000"          # Number of iterations/time-steps, or "" (use case settings)
...
CASE_DIRS=("AoA0" "AoA1" "AoA2" "AoA3" "AoA4" "AoA5" "AoA6" "AoA7" "AoA8" "AoA9" "AoA10" "AoA11" "AoA12" "AoA13" "AoA14" "AoA15" "AoA16" "AoA17" "AoA18" "AoA19" "AoA20" "AoA21" "AoA22" "AoA23" "AoA24" "AoA25" "AoA26" "AoA27" "AoA28")
...
setup_solver() {
    ...
    case $solver in
        fluent)
            ...
            SOLVER_ARGS="-ssh -gu -cflush -pib -pib.ofed"
...
; Override autosave root name to prevent Windows path
/file/auto-save/root-name
${job_dir}/${casefile%.cas.h5}
